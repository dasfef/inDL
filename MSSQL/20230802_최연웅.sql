...
select USER_NAME, ACCOUNT_YEAR, 설명, LEAVE_COUNT
	from(select USER_NAME, ACCOUNT_YEAR, 
				convert(nvarchar(10), convert(numeric(18,2), (OCCURED_COUNT+ADDED_COUNT+CARRIED_COUNT+ADJUST_COUNT+INTERIM_ENTRY_LEAVE))) as '총휴가수', 
				convert(nvarchar(10), convert(numeric(18,2),USED_COUNT)) as '사용휴가수', 
				convert(nvarchar(10), convert(numeric(18,2),((OCCURED_COUNT+ADDED_COUNT+CARRIED_COUNT+ADJUST_COUNT+INTERIM_ENTRY_LEAVE) - USED_COUNT))) as '남은휴가수' 
